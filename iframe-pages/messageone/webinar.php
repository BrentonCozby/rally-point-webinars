...
<?php $courseMap = array("35" => "http://rpw.adobeconnect.com/messageone05032016", "64" => "http://rpw.adobeconnect.com/messageone08022016"); ?>
...
<head>
    ...
    <meta property=og:url content="http://messageone.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://messageone.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://messageone.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
