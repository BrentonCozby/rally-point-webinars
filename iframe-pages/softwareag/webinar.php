...
<?php $courseMap = array("36" => "http://rpw.adobeconnect.com/sag04282016", "37" => "http://rpw.adobeconnect.com/sag04262016", "43" => "http://rpw.adobeconnect.com/softwareag05242016", "49" => "http://rpw.adobeconnect.com/softwareag05122016", "50" => "http://rpw.adobeconnect.com/sag_aris06232016", "102" => "http://rpw.adobeconnect.com/sag-vea11032016", "106" => "http://rpw.adobeconnect.com/sag-vea11152016", "107" => "http://rpw.adobeconnect.com/softwareag12082016"); ?>
...
<head>
    ...
    <meta property=og:url content="http://softwareag.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://softwareag.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://softwareag.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
