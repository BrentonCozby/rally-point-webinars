...
<?php $courseMap = array("187" => "http://rpw.adobeconnect.com/km-recording1172018"); ?>
...
<head>
    ...
    <meta property=og:url content="http://knowledgemarketing.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://knowledgemarketing.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://knowledgemarketing.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
