...
<?php $courseMap = array("178" => "http://everestworld.rallypointwebinars.com/demandRecording/2067?source=ondemand"); ?>
...
<head>
    ...
    <meta property=og:url content="http://everestworld.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://everestworld.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://everestworld.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
