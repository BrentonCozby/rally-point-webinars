...
<?php $courseMap = array("23" => "http://rpw.adobeconnect.com/moldover04072016", "96" => "http://rpw.adobeconnect.com/drmoldover11152016"); ?>
...
<head>
    ...
    <meta property=og:url content="http://drmoldover.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://drmoldover.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://drmoldover.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
