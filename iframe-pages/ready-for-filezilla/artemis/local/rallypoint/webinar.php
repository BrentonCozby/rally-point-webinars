...
<?php $courseMap = array("38" => "http://rpw.adobeconnect.com/artemis05102016", "39" => "http://rpw.adobeconnect.com/artemis05122016", "44" => "http://rpw.adobeconnect.com/artemisviews05182016", "45" => "http://rpw.adobeconnect.com/artemis05252016", "46" => "http://rpw.adobeconnect.com/accept36006082016", "167" => "http://artemis-accept.rallypointwebinars.com/demandRecording/1358?source=ondemand", "168" => "http://artemis9000.rallypointwebinars.com/demandRecording/752?source=ondemand", "169" => "http://artemisviews.rallypointwebinars.com/demandRecording/237?source=ondemand", "170" => "http://artemis7.rallypointwebinars.com/demandRecording/322?source=ondemand"); ?>
...
<head>
    ...
    <meta property=og:url content="http://artemis.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://artemis.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://artemis.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
