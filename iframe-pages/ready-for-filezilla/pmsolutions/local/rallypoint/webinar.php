...
<?php $courseMap = array("31" => "http://rpw.adobeconnect.com/pmsolutions04122016", "105" => "http://rpw.adobeconnect.com/pmsolutions11162016", "138" => "http://rpw.adobeconnect.com/pmsolutions05232017", "189" => "http://rpw.adobeconnect.com/recording-pmsolutions13018"); ?>
...
<head>
    ...
    <meta property=og:url content="http://pmsolutions.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://pmsolutions.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://pmsolutions.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
