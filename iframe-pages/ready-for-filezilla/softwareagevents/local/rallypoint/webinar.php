...
<?php $courseMap = array("67" => "http://rpw.adobeconnect.com/apics-sag07272016", "76" => "http://rpw.adobeconnect.com/sag-servicemax08172016", "99" => "http://rpw.adobeconnect.com/softwareag10202016"); ?>
...
<head>
    ...
    <meta property=og:url content="http://softwareagevents.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://softwareagevents.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://softwareagevents.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
