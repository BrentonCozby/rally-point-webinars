...
<?php $courseMap = array("180" => "http://researchnowssi.rallypointwebinars.com/demandRecording/929?source=ondemand"); ?>
...
<head>
    ...
    <meta property=og:url content="http://researchnow.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://researchnow.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://researchnow.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
