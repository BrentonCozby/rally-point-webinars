...
<?php $courseMap = array("139" => "http://sdlcpartners.rallypointwebinars.com/demandRecording/272?source=ondemand"); ?>
...
<head>
    ...
    <meta property=og:url content="http://sdlcpartners.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://sdlcpartners.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://sdlcpartners.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
