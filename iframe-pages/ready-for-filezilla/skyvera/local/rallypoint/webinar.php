...
<?php $courseMap = array("174" => "http://rpw.adobeconnect.com/skyveraq42017vuc", "186" => "http://skyvera.rallypointwebinars.com/demandRecording/558?source=ondemand"); ?>
...
<head>
    ...
    <meta property=og:url content="http://skyvera.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://skyvera.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://skyvera.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
