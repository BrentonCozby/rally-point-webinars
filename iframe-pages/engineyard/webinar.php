...
<?php $courseMap = array("23" => "http://rpw.adobeconnect.com/moldover04072016", "96" => "http://rpw.adobeconnect.com/drmoldover11152016", "146" => "http://rpw.adobeconnect.com/engineyard06292017", "162" => "http://rpw.adobeconnect.com/eyvucq30217", "183" => "http://rpw.adobeconnect.com/eyvucq42017"); ?>
...
<head>
    ...
    <meta property=og:url content="http://engineyard.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://engineyard.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://engineyard.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
