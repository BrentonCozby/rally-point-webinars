...
<?php $courseMap = array("26" => "http://rpw.adobeconnect.com/epmlive03222016", "52" => "http://rpw.adobeconnect.com/epmlive06212016", "87" => "http://rpw.adobeconnect.com/epmlive09272016", "112" => "http://rpw.adobeconnect.com/epmlive01102017", "120" => "http://rpw.adobeconnect.com/epmlive04182017", "151" => "http://rpw.adobeconnect.com/p7ep4if9kfy8", "177" => "http://rpw.adobeconnect.com/epmliveq42017"); ?>
...
<head>
    ...
    <meta property=og:url content="http://epmlive.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://epmlive.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://epmlive.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
