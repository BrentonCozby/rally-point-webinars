...
<?php $courseMap = array("16" => "http://rpw.adobeconnect.com/nuview03152016", "48" => "http://rpw.adobeconnect.com/ignitesensageap51716", "54" => "http://rpw.adobeconnect.com/sensage07132016", "62" => "http://rpw.adobeconnect.com/ignite-acorn07212016", "98" => "http://rpw.adobeconnect.com/ignite10212016", "109" => "http://rpw.adobeconnect.com/ignite12012016", "110" => "http://rpw.adobeconnect.com/ignite12072016", "155" => "http://rpw.adobeconnect.com/firstrainq32017"); ?>
...
<head>
    ...
    <meta property=og:url content="http://ignite.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    ...
    <meta name=twitter:site content="http://ignite.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <link rel=canonical href="http://ignite.rallypointwebinars.technology/local/rallypoint/webinar.php?id=<?php echo htmlspecialchars($_GET['id']) ?>">
    <!-- favicons -->
